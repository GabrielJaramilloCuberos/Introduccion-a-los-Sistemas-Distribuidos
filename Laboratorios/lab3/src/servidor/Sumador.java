...
public interface Sumador extends java.rmi.Remote {
  ...
  public int sumar(int a, int b) throws java.rmi.RemoteException; // La cláusula "throws java.rmi.RemoteException" es obligatoria
  // porque Puede fallar por problemas de red, de comunicación con el servidor o de disponibilidad del objeto remoto.
